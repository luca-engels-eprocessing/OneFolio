...
export default function Navbar() {
    ...
    return (
        <div className={"xl:ml-8 flex flex-row xl:flex-col justify-center items-center xl:h-screen h-[10vh] bg-sec xl:bg-transparent xl:border-0 border-t-accent border-t-2"}>
